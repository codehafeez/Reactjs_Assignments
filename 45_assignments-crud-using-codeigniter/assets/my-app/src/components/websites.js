...
class Websites extends React.Component {
	...
	componentDidMount() {
		fetch('http://localhost/ci_react-master/index.php/websiterestcontroller/websites')
			.then(response => {
	...
	deleteWebsite(id) {
		if(window.confirm("Are you sure want to delete?")) {
			fetch('http://localhost/ci_react-master/index.php/websiterestcontroller/delete_website/' + id, {
                                method : 'DELETE'
                                   }).then(response => { 
